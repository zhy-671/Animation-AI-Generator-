...
import { useMediaStore, getMediaAspectRatio } from "@/lib/opencut/stores/media-store";
import { useTimelineStore } from "@/lib/opencut/stores/timeline-store";
import { DEFAULT_CANVAS_SIZE, useProjectStore } from "@/lib/opencut/stores/project-store";
